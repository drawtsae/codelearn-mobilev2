...
final _courseMapper = JsonObjectMapper(
  (CustomJsonMapper mapper, Map<String, dynamic> json) => Course(
    ...
    additionalFields: (json['additionalFields'] as List?)
        ?.cast<Map<String, dynamic>>()
        .map((item) => mapper.deserialize<AdditionalField>(item)!)
        .toList(),
    ...
    lastModifiedBy:
        mapper.applyDynamicFromJsonConverter(json['lastModifiedBy']),
    lastModifiedAt:
        mapper.applyDynamicFromJsonConverter(json['lastModifiedAt']),
    author: mapper.deserialize<Author>(json['author'] as Map<String, dynamic>?),
    lessons: (json['lessons'] as List?)
        ?.cast<Map<String, dynamic>>()
        .map((item) => mapper.deserialize<Lesson>(item)!)
        .toList(),
    comments: (json['comments'] as List?)
        ?.cast<Map<String, dynamic>>()
        .map((item) => mapper.deserialize<Comment>(item)!)
        .toList(),
    categories: (json['categories'] as List?)
        ?.cast<Map<String, dynamic>>()
        .map((item) => mapper.deserialize<Category>(item)!)
        .toList(),
  ...
  (CustomJsonMapper mapper, Course instance) => <String, dynamic>{
    ...
    'sortPriority':
        mapper.applyDynamicFromInstanceConverter(instance.sortPriority),
    ...
    'enrolledCount':
        mapper.applyDynamicFromInstanceConverter(instance.enrolledCount),
    ...
    'lastModifiedBy':
        mapper.applyDynamicFromInstanceConverter(instance.lastModifiedBy),
    'lastModifiedAt':
        mapper.applyDynamicFromInstanceConverter(instance.lastModifiedAt),
    'author': mapper.serializeToMap(instance.author),
    'lessons':
        instance.lessons?.map((item) => mapper.serializeToMap(item)).toList(),
    'comments':
        instance.comments?.map((item) => mapper.serializeToMap(item)).toList(),
...
final _postMapper = JsonObjectMapper(
  (CustomJsonMapper mapper, Map<String, dynamic> json) => Post(
    ...
    lastModifiedAt:
        mapper.applyDynamicFromJsonConverter(json['lastModifiedAt']),
    courseId: mapper.applyDynamicFromJsonConverter(json['courseId']),
    ...
    additionalInfos: (json['additionalInfos'] as List?)
        ?.cast<Map<String, dynamic>>()
        .map((item) => mapper.deserialize<AdditionalInfo>(item)!)
        .toList(),
    testCases: (json['testCases'] as List?)
        ?.cast<Map<String, dynamic>>()
        .map((item) => mapper.deserialize<TestCase>(item)!)
        .toList(),
  ),
  (CustomJsonMapper mapper, Post instance) => <String, dynamic>{
    ...
    'lastModifiedAt':
        mapper.applyDynamicFromInstanceConverter(instance.lastModifiedAt),
    'courseId': mapper.applyDynamicFromInstanceConverter(instance.courseId),
    ...
    'sortPriority':
        mapper.applyDynamicFromInstanceConverter(instance.sortPriority),
    'lessonLevel':
        mapper.applyDynamicFromInstanceConverter(instance.lessonLevel),
    'summary': mapper.applyDynamicFromInstanceConverter(instance.summary),
    'isActive': mapper.applyDynamicFromInstanceConverter(instance.isActive),
    'content': mapper.applyDynamicFromInstanceConverter(instance.content),
    ...
    'additionalInfos': instance.additionalInfos
        ...
        .toList(),
    'testCases':
        instance.testCases?.map((item) => mapper.serializeToMap(item)).toList(),
  },
);
...
final _authorMapper = JsonObjectMapper(
  (CustomJsonMapper mapper, Map<String, dynamic> json) => Author(
    ...
    profilePicture:
        mapper.applyDynamicFromJsonConverter(json['profilePicture']),
    ...
    additionalFields:
        mapper.applyDynamicFromJsonConverter(json['additionalFields']),
  ...
  (CustomJsonMapper mapper, Author instance) => <String, dynamic>{
    ...
    'profilePicture':
        mapper.applyDynamicFromInstanceConverter(instance.profilePicture),
    ...
    'additionalFields':
        mapper.applyDynamicFromInstanceConverter(instance.additionalFields),
...
final _commentMapper = JsonObjectMapper(
  ...
  (CustomJsonMapper mapper, Comment instance) => <String, dynamic>{
    ...
    'parentId': mapper.applyDynamicFromInstanceConverter(instance.parentId),
    'commentLevel':
        mapper.applyDynamicFromInstanceConverter(instance.commentLevel),
    'isActive': mapper.applyDynamicFromInstanceConverter(instance.isActive),
    'content': mapper.applyDynamicFromInstanceConverter(instance.content),
...
final _categoryMapper = JsonObjectMapper(
  ...
  (CustomJsonMapper mapper, Category instance) => <String, dynamic>{
    ...
    'parentId': mapper.applyDynamicFromInstanceConverter(instance.parentId),
    'categoryLevel':
        mapper.applyDynamicFromInstanceConverter(instance.categoryLevel),
    'code': mapper.applyDynamicFromInstanceConverter(instance.code),
...
final _additionalinfoMapper = JsonObjectMapper(
  (CustomJsonMapper mapper, Map<String, dynamic> json) => AdditionalInfo(
    code: mapper.applyDynamicFromJsonConverter(json['code']),
    value: mapper.applyDynamicFromJsonConverter(json['value']),
  ),
  (CustomJsonMapper mapper, AdditionalInfo instance) => <String, dynamic>{
    'code': mapper.applyDynamicFromInstanceConverter(instance.code),
    'value': mapper.applyDynamicFromInstanceConverter(instance.value),
  },
);
...
final _testcaseMapper = JsonObjectMapper(
  (CustomJsonMapper mapper, Map<String, dynamic> json) => TestCase(
    ...
    expectedOutput:
        mapper.applyDynamicFromJsonConverter(json['expectedOutput']),
  ...
  (CustomJsonMapper mapper, TestCase instance) => <String, dynamic>{
    ...
    'expectedOutput':
        mapper.applyDynamicFromInstanceConverter(instance.expectedOutput),
...
void init() {
  ...
  JsonMapper.register(_additionalinfoMapper);
  ...
  JsonMapper.registerListCast(
      (value) => value?.cast<AdditionalField>().toList());
  ...
  JsonMapper.registerListCast(
      (value) => value?.cast<AdditionalInfo>().toList());
